...
- [x] `.env` en `.gitignore` desde el primer commit
- [x] Validar que el SQL generado solo contiene SELECT (rechazar INSERT, UPDATE, DELETE, DROP, ALTER)
- [x] Usar `mysql2/promise` con parámetros escapados
...
| Recurso                           | URL                                                                                                    |
| --------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Google AI Studio (API Key Gemini) | [https://ai.google.dev](https://ai.google.dev)                                                         |
| Gemini API docs                   | [https://ai.google.dev/gemini-api/docs](https://ai.google.dev/gemini-api/docs)                         |
| Gemini Text-to-SQL prompt guide   | [https://ai.google.dev/gemini-api/docs/text-to-sql](https://ai.google.dev/gemini-api/docs/text-to-sql) |
...
| Repositorio                       | [https://github.com/JuanmadelosH/NutriBI](https://github.com/JuanmadelosH/NutriBI)                     |
